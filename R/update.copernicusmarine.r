...
update.copernicusmarine<-function(){
  ...
  pythonpath=gsub("mamba","python",mambapath)
  condapath=gsub("mamba","python",mambapath)
  ...
  # system(paste(paste0(mambapath," init")))
  # system(paste(paste0(mambapath," activate cmc &&"),paste0(pythonpath," -m pip install copernicusmarine --upgrade"),sep=" "),invisible = F)
  system(paste(paste0(mambapath," init && ",mambapath," activate cmc &&"),paste0(pythonpath," -m pip install copernicusmarine --upgrade"),sep=" "),invisible = F)
